                ...
                <div class="col-lg-6 border border-primary border-3 rounded-3">
                    ...
                    <form action="UpdateCustomerAccount" method="post" >
                        ...
                        <div class="mt-3">
                            ...
                            <input type="text" class="form-control border border-2" name="ID" value="${u.ID}"readonly>                                
                        </div>
                        <div class="mt-3">
                            <label class="form-label">Customer ID</label>
                            <input type="text" class="form-control border border-2" name="CUSTOMERID" value="${u.customerID}"readonly>                                
                        </div>
                        <div class="mt-3">
                        ...
                        <div class="mt-3">
                            ...
                            <input type="text" class="form-control border border-2" name="CUSTOMERNAME" value="${u.customerName}" required>                                
                        </div>       
                        <div class="my-3">
