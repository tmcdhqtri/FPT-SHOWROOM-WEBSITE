<%-- 
    Document   : faq
    Created on : Jul 12, 2022, 7:59:58 PM
    Author     : Admin
--%>
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<h2 class="m-n"><i class="fa fa-question-circle"></i> 
Don't look at this part. This part is not complete yet.</h2>
							<p>
Don't look at this part. This part is not complete yet.</p>
