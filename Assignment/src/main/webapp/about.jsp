<%-- 
    Document   : about.jsp
    Created on : Jul 12, 2022, 7:55:35 PM
    Author     : Admin
--%>
        ...
        <div id="wrapper">
            ...
            <div id="main">
                <div class="inner">
                    ...
                    <p>We are students of FPT University doing a project for PRJ301. The website was created to search for cars and buy and sell cars to make it more convenient for customers to buy cars. Because of the limited time, some features of the web will run unstable and the features will not be as full as they appeared.</p>
